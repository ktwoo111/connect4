...
4. 
The maxconnect4.java is the main frame calling AiPlayer class which contains the logic for minimax. The herustic for evaluation function is counting the number of four, three, and two streaks, giving them different weights. Then, it was (player's value) - (opponent's value).The GameBoard.java is mainly for display purposes only.
